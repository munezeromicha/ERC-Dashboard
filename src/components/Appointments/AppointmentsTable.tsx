...
const AppointmentList = () => {
  ...
  const fetchAppointments = async () => {
    try {
      const response = await axios.get('https://wizzy-africa-backend.onrender.com/api/appointments/');
  ...
  const handleDelete = async (id: string) => {
    try {
      await axios.delete(`https://wizzy-africa-backend.onrender.com/api/appointments/${id}`);
